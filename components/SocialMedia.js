...
const SocialMedia = () => {
  return (
    <div className="text-white fixed flex flex-col social">
      <a href="https://wa.me/59170112241" target="_blank" className="bg-gray-600 bg-opacity-40 flex m-1 px-4 py-2 rounded-full w-full justify-end">
        WhatsApp
        <svg class="h-8 w-8 inline ml-2"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" />  <path d="M15 7a2 2 0 0 1 2 2" />  <path d="M15 3a6 6 0 0 1 6 6" /></svg>
      </a>
      <a href="https://www.facebook.com/SocemUnivalleLP" target="_blank" className="bg-gray-600 bg-opacity-40 flex m-1 px-4 py-2 rounded-full w-full justify-end">
        Facebook
      ...
      <a href="https://youtube.com/c/SOCEMUVLP" target="_blank" className="bg-gray-600 bg-opacity-40 m-1 px-4 py-2 rounded-full w-full flex justify-end">
        YouTube
